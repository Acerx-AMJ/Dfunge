...
|;|Pop from stack, if it's nonzero, set PC direction to right|0|
|j|Pop from stack, if it's nonzero, set PC direction to left|0|
|l|Pop from stack, if it's nonzero, set PC direction to up|0|
|k|Pop from stack, if it's nonzero, set PC direction to down|0|
...
|_|Pop two values, if they're both nonzero, push 1, else 0|2|
|\||Pop two values, if one or both of them are nonzero, push 1, else 0|2|
